...
export function ProjectList({
  ...
  const sortedProjects = [...projects].sort((a, b) => {
    ...
    const aDeleted = a.currentStatus === "DELETED" || (a.currentStatus === "MISSING" && a.targetedStatus === "DELETED");
    const bDeleted = b.currentStatus === "DELETED" || (b.currentStatus === "MISSING" && b.targetedStatus === "DELETED");
    ...
    if (!aDeleted && a.targetedStatus === "RUNNING" && (a.currentStatus as string) !== "RUNNING") return -1;
    if (!bDeleted && b.targetedStatus === "RUNNING" && (b.currentStatus as string) !== "RUNNING") return 1;
